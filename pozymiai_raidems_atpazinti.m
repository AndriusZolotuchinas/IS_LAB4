...
figure(12), imshow(V)
%% Raidþiø iðkirpimas ir sudëliojimas �? kintamojo 'objektai' celes |
...
% surûðiojami objektai pagal x koordinatæ - stulpel�?
% arrange objects according to the column number
O_centras = sortrows(O_centras,2);
% rûðiojama atsiþvelgiant �? pavyzdþiø eiluèiø ir raidþiø skaièiø
...
% vaizdo fragmentai apkerpami, panaikinant fonà ið kraðtø (pagal staèiakamp�?)
...
for k = 1:Skaicius % Skaicius = 88, jei yra 88 raidës
    ...
    objektai{k}=V_fragmentas;% �?raðome vietoje neapkarpyto
end
% vieno ið vaizdo fragmentø atvaizdavimas
% show the segment
figure(6),
...
for k=1:Skaicius
    ...
    % iðsaugome apskaièiuotus poþymius �? bendrà kintamàj�?
